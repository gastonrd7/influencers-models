...
enum campaignFields {
    ...
    customAdPrice = "adPrice",
    customBannerPrice = "bannerPrice",
    customHashtagPrice = "hashtagPrice",
    customWebSitePrice = "webSitePrice",
    customTagMentionMePrice = "tagMentionMePrice",
    customSealPrice = "sealPrice",
    customTagMentionPeoplePrice = "tagMentionPeoplePrice",
    customProductUsagePrice = "productUsagePrice",
    customInsightMultiplier = "insightMultiplier",
    specificTarget = "specificTarget",
